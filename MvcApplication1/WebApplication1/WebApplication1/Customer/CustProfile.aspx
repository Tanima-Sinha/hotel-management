...
<body>
    ...
    <!-- View Profile Panel -->
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Btnhistory" runat="server" Text="View History" OnClick="btnHistory_Click" Width="140px" />
        &nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="btneditprofile" runat="server" Text="Edit Profile" OnClick="btneditprofile_Click" Width="117px" />
